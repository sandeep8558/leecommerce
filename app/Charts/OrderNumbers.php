...
class OrderNumbers extends Chart
{
    /**
    ...
    public function __construct($what='Day', $typ='line', $duration=0, $page=1)
    {
        ...
        switch($what){
            ...
            for($i=$s;$i<$l;$i++){
                ...
                $data[] = Order::where('orderstatus', 'Success')->whereDate('created_at', $dt)->count();
            }
            break;
            ...
            for($i=$s;$i<$l;$i++){
                ...
                $data[] = Order::where('orderstatus', 'Success')->whereYear('created_at', $y)->whereMonth('created_at', $m)->count();
            }
            break;
            ...
            for($i=$s;$i<$l;$i++){
                ...
                $data[] = Order::where('orderstatus', 'Success')->whereYear('created_at', $y)->count();
            }
            break;
        ...
        $this->dataset('Orders', $typ, $data)->color($color)->backgroundColor($color.'20')->fill(true);
