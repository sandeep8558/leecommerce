        ...
        <div class="col-12 col-lg-6">
            ...
            <div id="carouselExampleIndicators1" class="carousel slide">
                ...
                <div class="carousel-indicators">
                    <button v-if="selectedProduct.media_a != null && selectedProduct.media_a != ''" type="button" data-bs-target="#carouselExampleIndicators1" data-bs-slide-to="0" aria-label="Slide 1" class="active" aria-current="true"></button>
                    <button v-if="selectedProduct.media_b != null && selectedProduct.media_b != ''" type="button" data-bs-target="#carouselExampleIndicators1" data-bs-slide-to="1" aria-label="Slide 2"></button>
                    <button v-if="selectedProduct.media_c != null && selectedProduct.media_c != ''" type="button" data-bs-target="#carouselExampleIndicators1" data-bs-slide-to="2" aria-label="Slide 3"></button>
                    <button v-if="selectedProduct.media_d != null && selectedProduct.media_d != ''" type="button" data-bs-target="#carouselExampleIndicators1" data-bs-slide-to="2" aria-label="Slide 3"></button>
                    <button v-if="selectedProduct.media_e != null && selectedProduct.media_e != ''" type="button" data-bs-target="#carouselExampleIndicators1" data-bs-slide-to="2" aria-label="Slide 3"></button>
                    <button v-if="selectedProduct.media_f != null && selectedProduct.media_f != ''" type="button" data-bs-target="#carouselExampleIndicators1" data-bs-slide-to="2" aria-label="Slide 3"></button>
                </div>
