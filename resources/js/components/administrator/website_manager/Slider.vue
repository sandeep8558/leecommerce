    ...
    data: function (){
        return {
            formData : {
                ...
                display : [
                    { key : 'title', val : 'Slide Title', type : 'text' },
                    { key : 'display', val : 'Display', type : 'text' },
                    { key : 'link', val : 'Link', type : 'text' },
                    { key : 'media', val : 'Media', type : 'image' },
                    { key : 'mobilemedia', val : 'Mobile Media', type : 'image' },
                ],
                elements : [
...

                    {
                        ...
                        ObjectValue : {},
                        options : [],
                        placeholder : 'Select Slide Media',
                        type : 'image',
                        validation : '',
                        class : 'col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-3',
                        labelClass : '',
                        hint : 'Slide Media is Required',
                        error : '',
                        isError : false,
                        readonly : false,
                    },
                    ...
                    {
                        label : 'Slide Mobile Media',
                        name : 'mobilemedia',
                        value : '',
                        values : [],
                        ObjectValue : {},
                        options : [],
                        placeholder : 'Select Slide Mobile Media',
                        type : 'image',
                        validation : '',
                        class : 'col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-3',
                        labelClass : '',
                        hint : 'Slide Mobile Media is Required',
                        error : '',
                        isError : false,
                        readonly : false,
                    },
